...
public final class RxActivityResult {
    ...
    public static class Builder<T> {
        ...
        public Observable<Result<T>> startIntent(final Intent intent, int requestCode) {
            return startIntent(intent, requestCode,null);
        }
        ...
        public Observable<Result<T>> startIntent(final Intent intent, int requestCode, @Nullable OnPreResult onPreResult) {
            return startHolderActivity(new Request(intent, requestCode), onPreResult);
        }
        ...
        private Observable<Result<T>> startHolderActivity(Request request, @Nullable OnPreResult onPreResult) {
            ...
            Log.d("RQC", request.getRequestCode()+"");
